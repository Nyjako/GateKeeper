...
The bot was built for servers where friends invite people for games and those people sometimes stay much longer than expected. Instead of removing users manually one by one, Gate Keeper handles it automatically.
